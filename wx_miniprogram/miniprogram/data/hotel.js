...
const demoOrders = [
  {
    ...
    status: "cancelled",
    paymentStatus: "未支付",
    cancelRule: getRoom("queen").cancelRule,
    address: hotel.address,
  },
  {
    id: "YS-DEMO-DONE",
    roomName: "榻榻米房",
    cover: getRoom("tatami").images[0],
    checkIn: "2026-06-10",
    checkOut: "2026-06-11",
    nights: 1,
    guests: 2,
    ...
    status: "completed",
    paymentStatus: "已支付",
    cancelRule: getRoom("tatami").cancelRule,
    address: hotel.address,
  },
  {
    id: "YS-DEMO-REFUND",
    roomName: "亲子海景套房201",
    cover: getRoom("room201").images[0],
    checkIn: "2026-05-01",
    checkOut: "2026-05-02",
    nights: 1,
    guests: 4,
    ...
    status: "refunded",
    paymentStatus: "已退款",
    cancelRule: getRoom("room201").cancelRule,
    address: hotel.address,
  },
];
